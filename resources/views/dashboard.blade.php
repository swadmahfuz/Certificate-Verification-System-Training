                    ...
                    if (searchX.length >= 3 || searchX.length === 0) {
                        $.ajax({
                            ...
                            beforeSend: function() {
                                ...
                                $(".search-result tbody").html('<tr><td colspan="11">Please wait while your query is being searched...</td></tr>'); // Ensure colspan matches the number of columns in your table
                            },
